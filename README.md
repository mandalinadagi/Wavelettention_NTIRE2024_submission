# WAVELETTENTION -- Team 17, code submission

Please install einops --> pip install einops

Since model size is larger than 100MB it is uploaded to drive and drive link is provided in model_zoo/team17_wavelettention.txt file.
