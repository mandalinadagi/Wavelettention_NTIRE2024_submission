...
class Wavelettention(nn.Module):
    r""" Hybrid Attention Transformer method is modified with additional Non Local Sparse Attention Blocks and trained by stationary wavelet losses in addition to l1
        HAT from: https://github.com/XPixelGroup/HAT
        NLSA from: https://github.com/HarukiYqM/Non-Local-Sparse-Attention 
